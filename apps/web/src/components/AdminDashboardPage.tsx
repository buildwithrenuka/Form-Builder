...
const ADMIN_THEMES: Record<HomeTheme, AdminPalette> = {
  dark: {
    bg: 'linear-gradient(160deg, #07050d 0%, #140b16 44%, #24111b 100%)',
    gridLine1: 'rgba(255,202,110,0.05)',
    gridLine2: 'rgba(198,94,120,0.04)',
    gridSize: '72px 72px',
    navBg: 'rgba(12,8,18,0.92)',
    navBorder: 'rgba(198,94,120,0.16)',
    navDivider: 'rgba(255,202,110,0.24)',
    panel: 'linear-gradient(160deg, rgba(198,94,120,0.08), rgba(255,202,110,0.04))',
    panelAlt: 'rgba(255,255,255,0.025)',
    panelBorder: 'rgba(255,231,205,0.09)',
    text: '#fff8f3',
    muted: 'rgba(238,205,214,0.62)',
    faint: 'rgba(238,205,214,0.4)',
    accentPrimary: '#7c3248',
    accentSecondary: '#d86e88',
    accentTertiary: '#ffca6e',
    accentQuaternary: '#fff1c4',
    accentPositive: '#22c55e',
    accentDanger: '#ffb0b0',
    auraA: 'radial-gradient(circle at 12% 18%, rgba(124,50,72,0.22), transparent 35%)',
    auraB: 'radial-gradient(circle at 82% 16%, rgba(216,110,136,0.16), transparent 30%)',
    auraC: 'radial-gradient(circle at 58% 78%, rgba(255,202,110,0.12), transparent 28%)',
    chipBg: 'rgba(255,255,255,0.04)',
    chipBorder: 'rgba(255,231,205,0.1)',
    inputBg: 'rgba(255,255,255,0.05)',
    inputBorder: 'rgba(255,231,205,0.12)',
    inputText: '#fff8f3',
  },
  light: {
    bg: '#fff6e8',
